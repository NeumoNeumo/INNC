...
public:
  ...
  static std::unique_ptr<TensorFrame> transpose(const std::shared_ptr<TensorFrame> &input, int dim0, int dim1);
...
public:
  ...
  static Tensor transpose(const std::shared_ptr<TensorFrame> &input, int dim0, int dim1);
